...
.cp{padding:20px 22px}.csm{padding:14px 16px}
...
.slbl{color:var(--dim);font-weight:500}.sval{font-family:'JetBrains Mono',monospace;font-size:11px;color:var(--muted)}
@keyframes spin{to{transform:rotate(360deg)}}.spin{display:inline-block;animation:spin .9s linear infinite}
@keyframes fu{from{opacity:0;transform:translateY(9px)}to{opacity:1;transform:translateY(0)}}.fu{animation:fu .32s ease both}
`;
...
function Spinner() {
  return (
    <svg width={15} height={15} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" className="spin">
...
// ── CHAT PANEL ────────────────────────────────────────────────────────────────
// Defined OUTSIDE Dashboard so it never remounts when Dashboard re-renders.
// Uses an uncontrolled ref for the textarea — no state update on keystroke.
      ...
      <div className="md-wrap">
        ...
        <div className="md-main">
          <div className="mob-bar">
            ...
            <button className="ibtn" onClick={()=>setSbOpen(true)}><Ic name="menu" s={15}/></button>
          </div>
            ...
            <div className="scroll">
              <div className="px fu" style={{paddingBottom:40}}>
                ...
                <div className="g4" style={{marginBottom:20}}>
                  {[
                    ...
                    <div key={k.l} className="kpi">
                      ...
                      <div className={`kpi-c ${k.ok?"pos":"neg"}`}><Ic name="trend" s={10} c="#4ade80"/>{k.c}</div>
                    </div>
                  ))}
                </div>
                ...
                <div className="ga" style={{marginBottom:28}}>
                  {MODULES.map(m=>(
                    <div key={m.id} className="mc" onClick={()=>go(m.id)} style={{background:m.bg,borderColor:m.border}}>
                  ...
                  <div>
                    ...
                    <div style={{display:"flex",flexDirection:"column",gap:7,marginBottom:18}}>
                      {[
                        ...
                        <button key={a.to} className="btn btn-g" style={{justifyContent:"flex-start",width:"100%"}} onClick={()=>go(a.to)}>
                    ...
                    <div className="card csm" style={{background:"rgba(99,102,241,.06)",borderColor:"rgba(99,102,241,.2)"}}>
                      ...
                      {[
                        ...
                        <div key={x.l} className="pr-row">
                          <div className="pr-meta"><span>{x.l}</span><span className="pr-val" style={{color:x.c}}>{x.p}%</span></div>
          ...
          {/* CHAT — ChatPanel is a stable component, never remounts */}
            ...
            <div className="scroll"><div className="px fu" style={{paddingBottom:40}}>
              ...
              <div style={{display:"flex",gap:9,alignItems:"center",marginBottom:22}}>
                <button className={`btn ${saved?"btn-ok":"btn-p"}`} onClick={saveDump} disabled={!dump.trim()}>
                  {saved?<><Ic name="check" s={13} c="#4ade80"/>Saved</>:<><Ic name="archive" s={13} c="#fff"/>Save Chronicle</>}
                </button>
              ...
              {[
                ...
                <div key={c.id} className="chr">
                  ...
                  <div style={{flex:1}}>
                    ...
                    <div style={{fontSize:11,color:"var(--dim)",marginTop:3}}>{c.type} · Chaos {c.chaos}/100 · {c.tone}</div>
                  </div>
                </div>
              ))}
            </div></div>
            ...
            <div className="scroll"><div className="px fu" style={{paddingBottom:40}}>
              ...
              {fMode ? (
                <div className="card cp" style={{background:"rgba(6,182,212,.07)",borderColor:"rgba(6,182,212,.28)",textAlign:"center",marginBottom:20}}>
                  ...
                  <p style={{fontSize:13,color:"var(--muted)",margin:"9px 0 15px",lineHeight:1.6}}>Stay in the work. Your attention is protected.</p>
              ...
              <div className="g3" style={{marginBottom:28}}>
                {FOCUS_MODES.map(m=>(
                  <div key={m.id} className={`fm${fMode===m.id?" on":""}`} onClick={()=>setFMode(fMode===m.id?null:m.id)}>
          ...
          {activeMod && !["home","chat","dump","focus","settings"].includes(section) && (
            <div className="scroll"><div className="px fu" style={{paddingBottom:40}}>
              <div style={{display:"flex",alignItems:"center",gap:13,marginBottom:22}}>
                ...
                <div>
                  <div className="sora" style={{fontWeight:800,fontSize:21,letterSpacing:"-.03em",color:activeMod.color}}>{activeMod.label}</div>
              ...
              <div className="g2">
                <div className="card csm">
                  ...
                  <code style={{fontFamily:"'JetBrains Mono',monospace",fontSize:12,color:activeMod.color}}>{activeMod.id}-module@2.0.0</code>
                </div>
                <div className="card csm">
