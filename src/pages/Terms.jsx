    ...
    <div style={{minHeight:'100vh',background:'#09090f',position:'relative'}}>
      ...
      <div style={{maxWidth:'760px',margin:'0 auto',padding:'clamp(24px, 5vw, 48px) clamp(16px, 5vw, 24px)',position:'relative',zIndex:1}}>
        ...
        <div style={{display:'flex',alignItems:'center',gap:'16px',marginBottom:'12px',flexWrap:'wrap'}}>
          ...
          <h1 style={{fontFamily:'Sora,sans-serif',fontWeight:'800',fontSize:'clamp(24px, 5vw, 32px)',color:'#ffffff',letterSpacing:'-0.03em',margin:0}}>Terms of Service</h1>
        </div>
        ...
        <div style={{display:'flex',flexDirection:'column',gap:'0'}}>
          {[
            ...
            },
            {
              ...
              content:'The Service and its original content, features, and functionality are and will remain the exclusive property of Mindoo and its licensors. Our trademarks and trade dress may not be used without prior written consent. You retain ownership of any content you create using the Service.'
            },
            {
              num:'06', title:'AI-Generated Content',
              content:'The Service uses artificial intelligence to generate responses, suggestions, and content. AI-generated content may not always be accurate, complete, or up to date. You are responsible for verifying any important information before acting on it. Mindoo is not liable for decisions made based on AI-generated content, and such content should not replace professional advice.'
            },
            {
            ...
            },
            {
              ...
              content:'To the maximum extent permitted by law, Mindoo shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including loss of profits, data, or goodwill, arising out of or in connection with your use of the Service. Our total liability shall not exceed the amount you paid to us in the twelve months preceding the claim.'
            },
            {
            ...
            },
            {
              ...
              content:'If you have any questions about these Terms of Service, please contact us at support@mindoo.app'
            },
            ...
            <div key={section.num} style={{display:'flex',gap:'clamp(12px, 3vw, 24px)'}}>
              ...
              <div style={{flex:1,paddingBottom:'40px',borderBottom: index < arr.length - 1 ? '1px solid rgba(255,255,255,0.05)' : 'none'}}>
        ...
        <div style={{marginTop:'40px',padding:'24px',background:'rgba(139,92,246,0.06)',border:'1px solid rgba(139,92,246,0.15)',borderRadius:'16px',textAlign:'center'}}>
          ...
          <p style={{fontFamily:'Inter,sans-serif',fontSize:'15px',fontWeight:'600',color:'#a78bfa'}}>support@mindoo.app</p>
        </div>
