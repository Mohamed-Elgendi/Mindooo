...
export default function SignIn() {
  ...
  return (
    <div className="page-bg flex items-center justify-center px-4 py-12" style={{minHeight:'100vh'}}>
      ...
      <div style={{width:'100%',maxWidth: showMotivation ? '860px' : '480px',transition:'max-width 0.4s ease'}}>
          ...
          {showMotivation && (
            ...
            >
              ...
              <p style={{
                ...
                color:'#ffffff',lineHeight:'1.35',letterSpacing:'-0.02em',marginBottom:'16px'
              }}>
                You are one step away from something powerful.
              </p>
              <p style={{
                fontFamily:'Inter,sans-serif',fontSize:'14px',
                color:'rgba(255,255,255,0.5)',lineHeight:'1.75',marginBottom:'16px'
              }}>
              ...
              <p style={{
                fontFamily:'Inter,sans-serif',fontSize:'14px',
                color:'rgba(255,255,255,0.5)',lineHeight:'1.75',marginBottom:'24px'
              }}>
                AXIS was built for that exact moment. It takes less than 60 seconds to unlock your second brain. No credit card. No complexity. Just you and your ideas — finally organized, finally moving forward.
              </p>
              <div style={{
                ...
                <p style={{
                  ...
                  Ready to start? Hit the <span style={{color:'#86efac',fontWeight:'700'}}>"Sign up free"</span> button below and maximize your brain power — it is waiting for you.
                </p>
              </div>
            </div>
          )}

          <div className="glass-card" style={{flex:'1',padding:'40px',minWidth:'0'}}>
            ...
            <div style={{borderTop:'1px solid rgba(255,255,255,0.06)',paddingTop:'20px'}}>
              <p style={{fontFamily:'Inter,sans-serif',fontSize:'12px',color:'rgba(255,255,255,0.25)',textAlign:'center',marginBottom:'12px'}}>
                Forgot which email you used? Check your password manager or inbox for a message from AXIS.
              </p>
