  ...
  const sections = [
    {
      num: '01',
      title: 'Introduction',
      content: 'AXIS ("we", "our", or "us") is committed to protecting your personal information and your right to privacy. This Privacy Policy explains how we collect, use, store, and protect your information when you use our Service. We take your privacy seriously and will never sell your personal data to third parties.'
    },
    {
      num: '02',
    ...
    },
    {
      ...
      content: 'We do not sell, trade, or rent your personal information to third parties. We may share your information only with trusted service providers that help us operate the Service (Supabase, Vercel, Resend), when required by law or court order, to protect the rights or safety of AXIS or our users, or in the event of a merger or acquisition where users will be notified before data is transferred.'
    },
    {
      num: '06',
      title: 'Your rights',
      content: 'You have the right to access a copy of the personal data we hold about you, request correction of inaccurate data, request deletion of your personal data, request your data in a portable format, object to processing of your personal data, restrict how we use your data, and withdraw consent at any time. To exercise any of these rights, contact us at privacy@axis-app.com'
    },
    {
      num: '07',
    ...
    },
    {
      num: '12',
      title: 'Contact us',
      content: 'If you have any questions, concerns, or requests regarding this Privacy Policy or our data practices, please contact our Privacy Team at privacy@axis-app.com. We respond within 72 hours.'
    },
  ]
    ...
    <div className="page-bg" style={{ minHeight: '100vh' }}>
      ...
      <div style={{ maxWidth: '760px', margin: '0 auto', padding: '48px 24px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '16px', marginBottom: '12px' }}>
          ...
          <div>
            <h1 style={{ fontFamily: 'Sora,sans-serif', fontWeight: '800', fontSize: '32px', color: '#ffffff', letterSpacing: '-0.03em', margin: 0 }}>Privacy Policy</h1>
          </div>
        </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0' }}>
          {sections.map((section, index) => (
            <div key={section.num} style={{ display: 'flex', gap: '24px' }}>
              ...
              <div style={{ flex: 1, paddingBottom: '40px', borderBottom: index < sections.length - 1 ? '1px solid rgba(255,255,255,0.05)' : 'none', marginBottom: index < sections.length - 1 ? '0' : '0' }}>
        ...
        <div style={{ marginTop: '40px', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
          <div style={{ padding: '20px', background: 'rgba(139,92,246,0.06)', border: '1px solid rgba(139,92,246,0.15)', borderRadius: '14px' }}>
            ...
            <p style={{ fontFamily: 'Inter,sans-serif', fontSize: '14px', fontWeight: '600', color: '#a78bfa' }}>support@axis-app.com</p>
          </div>
          <div style={{ padding: '20px', background: 'rgba(139,92,246,0.06)', border: '1px solid rgba(139,92,246,0.15)', borderRadius: '14px' }}>
            ...
            <p style={{ fontFamily: 'Inter,sans-serif', fontSize: '14px', fontWeight: '600', color: '#a78bfa' }}>privacy@axis-app.com</p>
          </div>
        </div>
